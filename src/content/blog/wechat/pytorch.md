---
title: 如何系统性定位并分析 PyTorch 模型推理中的性能瓶颈
slug: pytorch
date: '2025-12-28'
tags: []
status: published
...
imported_at: '2025-12-28T07:19:02.642Z'
cover: /images/wechat/pytorch/001-c23cddc4.png
---
...
![图片](/images/wechat/pytorch/001-c23cddc4.png)

# 0x1. H100 单卡 benchmark对齐

首先需要复现结果，然后再去找问题。通过[社区投稿｜LightX2V Day-0支持Qwen-Image-Edit-2511模型，加速超42倍！](https://mp.weixin.qq.com/s?__biz=Mzk3NTQ0MjQ4NQ==&mid=2247484324&idx=1&sn=70a52de3f3c11703b28c296374a20883&scene=21#wechat_redirect)这篇帖子的数据图片可以看到跑完整的40 steps时SGLang generate比LightX2V要慢：

![图片](/images/wechat/pytorch/002-f792d490.png)
...
然后 https\://github.com/sgl-project/sglang/blob/main/python/sglang/multimodal_gen/configs/models/dits/qwenimage.py[#L23](javascript:;) 这里的zero_cond_t改成True才能和上面对齐。
...
![图片](/images/wechat/pytorch/003-520daf76.png)
...
![图片](/images/wechat/pytorch/007-d0b7b4e2.png)

![图片](/images/wechat/pytorch/008-6b7f41df.png)
...
![图片](/images/wechat/pytorch/009-087bffa1.png)

![图片](/images/wechat/pytorch/010-0237930d.png)
...
![图片](/images/wechat/pytorch/011-ab804710.png)

![图片](/images/wechat/pytorch/012-4b237fba.png)

这个问题就比较有趣了，我发现rope之后，attention之前有这三行代码：

https\://github.com/sgl-project/sglang/blob/a8785f5a87ae4ba5315d33da7aba1db33d45ed95/python/sglang/multimodal_gen/runtime/models/dits/qwen_image.py[#L406](javascript:;)
...
![图片](/images/wechat/pytorch/013-8b8037c1.png)

![图片](/images/wechat/pytorch/014-700617c1.png)

但是SGLang generate中出现了奇怪的问题，我发现第三个kernel很慢，比前面2个加起来还慢。第一个和第二个kernel是62us，第三个是155us。

![图片](/images/wechat/pytorch/015-e3c5d854.png)

![图片](/images/wechat/pytorch/016-e0d6eded.png)
...
![图片](/images/wechat/pytorch/017-58cccbcd.png)

## sglang main(6.1ms)

![图片](/images/wechat/pytorch/018-7837a116.png)

## pr(5.19ms)

![图片](/images/wechat/pytorch/019-cb1ca634.png)
