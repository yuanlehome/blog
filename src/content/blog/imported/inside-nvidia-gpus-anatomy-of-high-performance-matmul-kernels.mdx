...
imported_at: '2025-12-28T12:06:36.101Z'
source:
...
![Figure 1: Model of the NVIDIA Hopper H100 GPU](/images/imported/inside-nvidia-gpus-anatomy-of-high-performance-matmul-kernels/001-8ee6a76e.png)
...
![Figure 2: Memory hierarchy of the H100 (SXM5) GPU](/images/imported/inside-nvidia-gpus-anatomy-of-high-performance-matmul-kernels/002-a9f61b85.png)
...
![Figure 3: H100 SXM5 BF16 speed-of-light derivation](/images/imported/inside-nvidia-gpus-anatomy-of-high-performance-matmul-kernels/003-9cf3af00.png)
...
![Figure 4: Power throttling reduces clock frequency and lowers the effective “speed of light”](/images/imported/inside-nvidia-gpus-anatomy-of-high-performance-matmul-kernels/004-821585f3.png)
...
![Figure 5: CUDA Programming Model: threads, warps, blocks, clusters, grids](/images/imported/inside-nvidia-gpus-anatomy-of-high-performance-matmul-kernels/005-0d49d664.png)
...
![Figure 6: CUDA's built-in variables: how threads know where they are](/images/imported/inside-nvidia-gpus-anatomy-of-high-performance-matmul-kernels/006-a3c6cd90.png)
...
![Figure 7: Inside a DRAM cell: transistor + capacitor, wordline + bitline](/images/imported/inside-nvidia-gpus-anatomy-of-high-performance-matmul-kernels/007-0c5a4437.png)
...
![Figure 8: GMEM model](/images/imported/inside-nvidia-gpus-anatomy-of-high-performance-matmul-kernels/008-dbb04e9b.png)
...
![Figure 9: Effect of access pattern in GMEM](/images/imported/inside-nvidia-gpus-anatomy-of-high-performance-matmul-kernels/009-9ffead5b.png)
...
![Figure 10: SMEM model](/images/imported/inside-nvidia-gpus-anatomy-of-high-performance-matmul-kernels/010-349393f4.png)
...
![Figure 11: SMEM: good vs. bad access patterns](/images/imported/inside-nvidia-gpus-anatomy-of-high-performance-matmul-kernels/011-651002e5.png)
...
![Figure 12: SMEM: multicasting (served in a single cycle)](/images/imported/inside-nvidia-gpus-anatomy-of-high-performance-matmul-kernels/012-2c95f4f4.png)
...
![Figure 13: L1 cache model](/images/imported/inside-nvidia-gpus-anatomy-of-high-performance-matmul-kernels/013-8e982c04.png)

Figure 13: L1 cache model

Let's go one level deeper and look at the tag stage and data stage in detail:

![Figure 14: Breakdown of k-way set-associative cache organization](/images/imported/inside-nvidia-gpus-anatomy-of-high-performance-matmul-kernels/014-c6c094a8.png)
...
![Figure 15: CUDA compilation flow: from CUDA C++ → PTX → SASS](/images/imported/inside-nvidia-gpus-anatomy-of-high-performance-matmul-kernels/015-aa3bd47e.png)
...
![Figure 16: Naive CPU matmul example](/images/imported/inside-nvidia-gpus-anatomy-of-high-performance-matmul-kernels/016-6bf0d586.png)
...
![Figure 17: Tile quantization](/images/imported/inside-nvidia-gpus-anatomy-of-high-performance-matmul-kernels/017-20e073fb.png)
...
![Figure 18: Thread organization in naive matmul kernel](/images/imported/inside-nvidia-gpus-anatomy-of-high-performance-matmul-kernels/018-9c5036fe.png)

Figure 18: Thread organization in naive matmul kernel

And the matmul logic itself looks like this:

![Figure 19: Naive matmul kernel](/images/imported/inside-nvidia-gpus-anatomy-of-high-performance-matmul-kernels/019-63cad355.png)
...
![Figure 20: Nsight Compute: Occupancy, Waves info](/images/imported/inside-nvidia-gpus-anatomy-of-high-performance-matmul-kernels/020-08298cc8.png)
...
![Figure 21: Wave quantization](/images/imported/inside-nvidia-gpus-anatomy-of-high-performance-matmul-kernels/021-90e8eef8.png)
...
![Figure 22: PTX code corresponding to naive matmul CUDA kernel](/images/imported/inside-nvidia-gpus-anatomy-of-high-performance-matmul-kernels/022-6ddbe5f8.png)
...
![Figure 23: SASS code corresponding to naive matmul CUDA kernel](/images/imported/inside-nvidia-gpus-anatomy-of-high-performance-matmul-kernels/023-8a52ed55.png)
...
![Figure 24: New logical organization of row2 and col2 variables](/images/imported/inside-nvidia-gpus-anatomy-of-high-performance-matmul-kernels/024-a1578a89.png)

Figure 24: New logical organization of row2 and col2 variables

And here's what the modified kernel does now:

![Figure 25: Naive kernel with uncoalesced GMEM access](/images/imported/inside-nvidia-gpus-anatomy-of-high-performance-matmul-kernels/025-a98a3759.png)
...
![Figure 26: Roofline model](/images/imported/inside-nvidia-gpus-anatomy-of-high-performance-matmul-kernels/026-5d1c148e.png)
...
![Figure 27: Matmul as a sum of partial outer products](/images/imported/inside-nvidia-gpus-anatomy-of-high-performance-matmul-kernels/027-d86b0b62.png)
...
![Figure 28: Dot product is equivalent to a sum of partial dot products](/images/imported/inside-nvidia-gpus-anatomy-of-high-performance-matmul-kernels/028-ba9329f3.png)
...
![Figure 29: Arithmetic intensity improves when each thread computes multiple outputs and when tiles approach a square shape](/images/imported/inside-nvidia-gpus-anatomy-of-high-performance-matmul-kernels/029-438eb3c2.png)
...
![Figure 30: High-level structure of the warp-tiling algorithm, also referred to as block tiling.](/images/imported/inside-nvidia-gpus-anatomy-of-high-performance-matmul-kernels/030-5306a1ba.png)
...
![Figure 31: Loading a chunk of B (GMEM) into Bs (SMEM)](/images/imported/inside-nvidia-gpus-anatomy-of-high-performance-matmul-kernels/031-636ace81.png)
...
![Figure 32: Loading a chunk of A (GMEM) into As (SMEM)](/images/imported/inside-nvidia-gpus-anatomy-of-high-performance-matmul-kernels/032-c438d970.png)
...
![Figure 33: Performing matmul between As and Bs as a series of thread-level outer products (warp-tiling + thread-tiling).](/images/imported/inside-nvidia-gpus-anatomy-of-high-performance-matmul-kernels/033-130a37f6.png)
...
![Figure 34: We keep the same high-level structure of the warp-tiling algorithm (block-tiling).](/images/imported/inside-nvidia-gpus-anatomy-of-high-performance-matmul-kernels/034-5640c629.png)
...
![Figure 35: Swizzling example](/images/imported/inside-nvidia-gpus-anatomy-of-high-performance-matmul-kernels/035-942f2ad1.png)
...
![Figure 36: No bank conflicts when loading rows or columns](/images/imported/inside-nvidia-gpus-anatomy-of-high-performance-matmul-kernels/036-e56ada57.png)
...
![Figure 37: Swizzle function intuition](/images/imported/inside-nvidia-gpus-anatomy-of-high-performance-matmul-kernels/037-faf268e7.png)
...
![Figure 38: Connecting the swizzle function to the matrix swizzle example](/images/imported/inside-nvidia-gpus-anatomy-of-high-performance-matmul-kernels/038-16982d93.png)
...
![Figure 39: Why doing four 64x16 @ 16x64 wgmma calls is equivalent to doing a 64x64 @ 64x64 matmul](/images/imported/inside-nvidia-gpus-anatomy-of-high-performance-matmul-kernels/039-c08b9966.png)
...
![Figure 40: We are wasting TMA and TC cycles - we can do better](/images/imported/inside-nvidia-gpus-anatomy-of-high-performance-matmul-kernels/040-12899786.png)
...
![Figure 41: More efficient TC/TMA pipeline: producer warp-group streams tiles into a circular buffer; consumer warp-group drains tiles into tensor cores.](/images/imported/inside-nvidia-gpus-anatomy-of-high-performance-matmul-kernels/041-12a260d3.png)
...
![Figure 42: Two consumer warp groups let us grow the tile from 128x128 -> 128x256 without register spills](/images/imported/inside-nvidia-gpus-anatomy-of-high-performance-matmul-kernels/042-b5e9ea8f.png)
...
![Figure 43: Persistent kernels: overlap the output store with incoming loads by launching one long-lived block per SM that processes many tiles.](/images/imported/inside-nvidia-gpus-anatomy-of-high-performance-matmul-kernels/043-688f6329.png)
...
![Figure 44: Naïve schedule](/images/imported/inside-nvidia-gpus-anatomy-of-high-performance-matmul-kernels/044-94473507.png)

Figure 44: Naïve schedule

Can we do better? Yes—by making the schedule cache-aware:

![Figure 45: Block-wise cache-aware schedule](/images/imported/inside-nvidia-gpus-anatomy-of-high-performance-matmul-kernels/045-9f30c858.png)

Figure 45: Block-wise cache-aware schedule

But can we do even better? Surprisingly, yes—by using a space-filling curve:

![Figure 46: Hilbert-curve schedule](/images/imported/inside-nvidia-gpus-anatomy-of-high-performance-matmul-kernels/046-22c81af3.png)
...
![Figure 47: Using thread block clusters to reduce the number of L2/GMEM loads.](/images/imported/inside-nvidia-gpus-anatomy-of-high-performance-matmul-kernels/047-21a30a9b.png)
